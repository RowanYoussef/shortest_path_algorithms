                                                    ...
                                                    switch (input) {
                                                        case "1" -> {
                                                            ...
                                                            if (algorithm.equals("1") || algorithm.equals("2")) {
                                                                if (g.getDistance(dest) == Double.MAX_VALUE)
                                                                    System.out.println("there is no path from " + src + " to " + dest);
                                                                else if (notCycle)
                                                                    System.out.println("path from " + src + " to " + dest + " = " + g.getParents(src, dest));
                                                                else
                                                                    System.out.println("graph contains a negative cycle we couldn't find the right path");
                                                            } else {
                                                                if (g.getDistance(src, dest) == Double.POSITIVE_INFINITY)
                                                                    System.out.println("there is no path from " + src + " to " + dest);
                                                                else if (g.solveForOne(dest, "2"))
                                            ...
                                            if (input.equals("3")) break;
                                                ...
                                                switch (input) {
                                                    case "1" -> {
                                                        ...
                                                        if (g.getDistance(src, dest) == Double.MAX_VALUE || g.getDistance(src, dest) == Double.POSITIVE_INFINITY)
                                                            System.out.println("there is no path from " + src + " to " + dest);
                                                        else if (g.solveForOne(src, "2"))
                                                            System.out.println("path from " + src + " to " + dest + " = " + g.getParentsAll(src, dest));
                                                        else
                                                            System.out.println("graph contains a negative cycle we couldn't find the right path");
                                                    }
