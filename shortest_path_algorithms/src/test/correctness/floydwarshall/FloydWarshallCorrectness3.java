...
public class FloydWarshallCorrectness3 {
    ...
    void src_to_all_dst1() {
        graph.solveFloydWarshall();
        double[] expected = {0.0, 30.0, 40.0, 60.0, 50.0, 140.0, 110.0, Double.POSITIVE_INFINITY};
    ...
    void src_to_all_dst2() {
        graph.solveFloydWarshall();
        double[] expected = {90.0, 0.0, 130.0, 50.0, 20.0, 230.0, 100.0, Double.POSITIVE_INFINITY};
    ...
    void src_to_all_dst3() {
        graph.solveFloydWarshall();
        double[] expected = {60.0, 90.0, 0.0, 20.0, 80.0, 100.0, 70.0, Double.POSITIVE_INFINITY};
    ...
    void src_to_all_dst5() {
        graph.solveFloydWarshall();
        double[] expected = {240.0, 270.0, 280.0, 200.0, 260.0, 0.0, 250.0, Double.POSITIVE_INFINITY};
    ...
    void all_nodes_to_all_nodes() {
        graph.solveFloydWarshall();
        double[][] expected = {
                {0.0, 30.0, 40.0, 60.0, 50.0, 140.0, 110.0, Double.POSITIVE_INFINITY},
                {90.0, 0.0, 130.0, 50.0, 20.0, 230.0, 100.0, Double.POSITIVE_INFINITY},
                {60.0, 90.0, 0.0, 20.0, 80.0, 100.0, 70.0, Double.POSITIVE_INFINITY},
                {40.0, 70.0, 80.0, 0.0, 60.0, 180.0, 50.0, Double.POSITIVE_INFINITY},
                {540.0, 570.0, 580.0, 500.0, 0.0, 300.0, 550.0, Double.POSITIVE_INFINITY},
                {240.0, 270.0, 280.0, 200.0, 260.0, 0.0, 250.0, Double.POSITIVE_INFINITY},
