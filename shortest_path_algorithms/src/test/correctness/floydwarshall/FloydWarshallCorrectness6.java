...
public class FloydWarshallCorrectness6 {
    ...
    void src_dst_cost2() {
        graph.solveForOne(0, "3");
        assertEquals(5, graph.getDistance(0, 4));
    }
    ...
    void src_dst_cost4() {
        ...
        assertEquals(4, graph.getDistance(5, 1));
    }
    @Test
...
/*
    ...
    void path_src_dst4() {
        graph.solveForOne(4, "3");
        assertEquals("0->2->3->5->4", graph.getParents(4, 0));
    }
*/
