...
public class BellmanFordCorrectness6 {
    Graph graph = new Graph("src/test/graphs/medium_negative.txt");

    @Test
    void src_dst_cost1() {
        graph.solveForOne(0, "2");
        assertEquals(0, graph.getDistance( 2));
    }

    @Test
    void src_dst_cost2() {
        graph.solveForOne(0, "2");
        assertEquals(5, graph.getDistance( 4));
    }
    ...
    void src_dst_cost4() {
        ...
        assertEquals(4, graph.getDistance( 1));
    }
    @Test
    void src_to_all_dst1() {
        graph.solveForOne(0, "2");
        double[] expected = {0.0, -2.0, 0.0, 1.0, 5.0, 3.0};
    ...
    void src_to_all_dst2() {
        ...
        double[] expected = {3.0, 0.0, 2.0, 3.0, 7.0, 5.0};
        assert Arrays.equals(expected, graph.getDistanceToAllDest());
    }
    ...
    void src_to_all_dst3() {
        ...
        double[] expected = {1.0, -1.0, 0.0, 2.0, 6.0, 4.0};
        assert Arrays.equals(expected, graph.getDistanceToAllDest());
    }
    ...
    void src_to_all_dst4() {
        graph.solveForOne(3, "2");
        double[] expected = {0.0, -2.0, -1.0, 0.0, 4.0, 2.0};
        assert Arrays.equals(expected, graph.getDistanceToAllDest());
    }
    ...
    void src_to_all_dst5() {
        ...
        double[] expected = {4.0, 2.0, 3.0, 4.0, 0.0, -2.0};
        assert Arrays.equals(expected, graph.getDistanceToAllDest());
    }
    ...
    void src_to_all_dst6() {
        graph.solveForOne(5, "2");
        double[] expected = {6.0, 4.0, 5.0, 6.0, 2.0, 0.0};
        assert Arrays.equals(expected, graph.getDistanceToAllDest());
    }
    ...
    void all_nodes_to_all_nodes() {
        graph.solveForAll("2");
        double[][] expected = {
                {0.0, -2.0, 0.0, 1.0, 5.0, 3.0},
                {3.0, 0.0, 2.0, 3.0, 7.0, 5.0},
                {1.0, -1.0, 0.0, 2.0, 6.0, 4.0},
                {0.0, -2.0, -1.0, 0.0, 4.0, 2.0},
                {4.0, 2.0, 3.0, 4.0, 0.0, -2.0},
                {6.0, 4.0, 5.0, 6.0, 2.0, 0.0}
        };
    ...
    void path_src_dst4() {
        graph.solveForOne(4, "2");
        assertEquals("4-5-3-2-0", graph.getParents(4, 0));
    }
